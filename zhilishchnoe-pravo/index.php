...
<h2 class="smaller">Адвокаты, оказывающие правовую помощь в отрасли Жилищное право</h2>
<div id="block-views-banners-block" class="block block-views contextual-links-region last even">
	<div class="view view-banners view-id-banners view-display-id-block slider-container view-dom-id-825ff0814b651951bf656ed4992115f3">
		<div class="view-content">
            ...
            $arrSfera = array("PROPERTY_SFERA_DET"=>106944);?>
 ...
 <div class="attachment attachment-before">
        <h2 class="smaller">Статьи адвокатов по теме Жилищное право</h2>
<?$arrPravo = array("PROPERTY_OTR_PRAVO"=>106944);?>         
			 <?$APPLICATION->IncludeComponent(
	"bitrix:news.list", 
	"blog", 
	array(
...
<div class="attachment attachment-before" style="margin-top:20px;">
        <h2 class="smaller">Ответы адвокатов на вопросы граждан в отрасли Жилищное право</h2>
<?$arrPravor = array("PROPERTY_OTR_PRAVO"=>106944);?>         
			 <?$APPLICATION->IncludeComponent(
	"bitrix:news.list", 
	"voprosy", 
	array(
