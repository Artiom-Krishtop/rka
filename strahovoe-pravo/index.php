...
<h2 class="smaller">Адвокаты, оказывающие правовую помощь в отрасли Страховое право</h2>
...
$arrSfera = array("PROPERTY_SFERA_DET"=>106961);?>
 ...
 <div class="attachment attachment-before">
        <h2 class="smaller">Статьи адвокатов по теме Страховое право</h2>
<?$arrPravo = array("PROPERTY_OTR_PRAVO"=>106961);?>         
			 <?$APPLICATION->IncludeComponent(
	"bitrix:news.list", 
	"blog", 
	array(
...
<div class="attachment attachment-before" style="margin-top:20px;">
        <h2 class="smaller">Ответы адвокатов на вопросы граждан в отрасли Страховое право</h2>
<?$arrPravor = array("PROPERTY_OTR_PRAVO"=>106961);?>         
			 <?$APPLICATION->IncludeComponent(
	"bitrix:news.list", 
	"voprosy", 
	array(
