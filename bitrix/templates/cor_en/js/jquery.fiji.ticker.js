...
jQuery.widget("fiji.ticker", {
	...
	destroy: function() {
		...
		return jQuery.Widget.prototype.destroy.call(self);
	},
    ...
    _nextItem: function(nextItem) {
		...
		if (nextItem != null && nextItem.length > 0) {
			...
			var jQuerynextItem = jQuery(nextItem);

			self._addItemBindings(jQuerynextItem);
			jQuerynextItem
				.hide()
...
jQuery.extend(jQuery.fiji.ticker, {
	version: "@VERSION"
});
