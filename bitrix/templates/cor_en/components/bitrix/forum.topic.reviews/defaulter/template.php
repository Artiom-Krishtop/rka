...
<div class="reviews-note-box reviews-note-note">
	<a name="reviewnote"></a>
    <?$ok_mess = str_replace("Сообщение успешно добавлено.","Паведамленне паспяхова дададзена.",$arResult["OK_MESSAGE"]);?>
    <?$ok_mess = str_replace("Оно станет доступно для просмотра после проверки модератором.","Яно стане даступна для прагляду пасля праверкі мадэратарам.",$ok_mess);?>
	<div class="reviews-note-box-text"><?=ShowNote($ok_mess);?></div>
</div>
<?
endif;
