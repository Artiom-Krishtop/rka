...
(function ($) {
    ...
    slider.setup = function(type) {
      ...
      if (!fade) {
        ...
        if (vertical && !carousel) {
          ...
          setTimeout(function(){
            slider.doMath();
            slider.newSlides.css({"width": slider.computedW, "float": "none", "display": "table-cell"});
            // SMOOTH HEIGHT:
            if (slider.vars.smoothHeight) methods.smoothHeight();
          }, (type === "init") ? 100 : 0);
        }
  ...
  $.flexslider.defaults = {
    ...
    manualControls: true,             //{UPDATED} jQuery Object/Selector: Declare custom control navigation. Examples would be $(".flex-control-nav li") or "#tabs-nav li img", etc. The number of elements in your controlNav should match the number of slides/tabs.
...
jQuery(window).load(function() {
  jQuery('.adv_flexslider').flexslider({
    animation: "slide",
    itemWidth: 136,
    itemMargin: 0,
	minItems: 6,
