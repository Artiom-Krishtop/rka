...
<h2 class="block-title"><?
    ...
    $APPLICATION->IncludeComponent(
        ...
        Array(
            "AREA_FILE_SHOW" => "file",
            "PATH" => SITE_DIR."include/main_active_advokat.php",
            "EDIT_TEMPLATE" => ""
        )
    );
	...
	<li class="views-row-odd" id="<?=$this->GetEditAreaId($arItem['ID']);?>">   
		...
		<?if($arParams["DISPLAY_NAME"]!="N" && $arItem["NAME"]):?>
            ...
            <div class="act_upper">
                ...
                <?$arOt = $arParams["USERS_ID"][$arItem['DISPLAY_PROPERTIES']['USER']['VALUE']]?>
                <strong><?=$arOt?> 
            ...
            <?$db_list = CIBlockSection::GetList(array(), array('GLOBAL_ACTIVE' => 'Y', "IBLOCK_ID" => 15, 'NAME'=>$arItem["PROPERTIES"]["KOLLEG"]["VALUE"]), true, array("ID", "NAME","UF_S_OLD_ID","SECTION_PAGE_URL","SECTION_ID"));
