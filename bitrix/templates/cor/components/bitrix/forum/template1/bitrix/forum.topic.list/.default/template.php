...
?>
                    ...
                    <?if($res["USER_START_NAME"]=="test test"){?>
<span class="forum-item-author"><span><?=GetMessage("F_AUTHOR")?></span>&nbsp; Гость</span>
                    <?}else{?> 
...
?>
						<div class="forum-lastpost-box">
							<span class="forum-lastpost-date" style="color: #85092d;"><?/*<noindex><a rel="nofollow" href="<?=$res["URL"]["LAST_MESSAGE"]?>">*/?><?=FormatDate('d F Y',MakeTimeStamp($res["LAST_POST_DATE"]), time())?><?//=$res["LAST_POST_DATE"]?><?/*</a></noindex>*/?></span>
