...
<div id="block-views-user-page-block-1" class="block block-views contextual-links-region first last odd">
    ...
    <div class="more-link" style="text-align: right;">
        <a href="/blogs/?blog=<?=$arrFilter["PROPERTY_USER"]?>" style="color: white!important;">Читать блог</a>
    </div>
    <?}?>
</div>
<div id="block-views-user-page-block-1" class="block block-views contextual-links-region first last odd">
...
?>
<div class="more-link" style="text-align: right;">
    <a href="/question/?question=<?=$arrFilter["PROPERTY_USER"]?>" style="color: white!important;">Все вопросы</a>
</div>
<?}?>
</div>
