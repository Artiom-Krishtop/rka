...
?>
	...
	?>
    <div style="width:33.3%;float:left;margin-bottom: 20px;" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		<span class="user-picture adv-pic">
			<a href="<?=$arItem["DETAIL_PAGE_URL"]?>" title="Информация о пользователе.">
                <img typeof="foaf:Image"
                     ...
                     alt="Аватар пользователя <?=$arItem["NAME"]?>" title="Аватар пользователя <?=$arItem["NAME"]?>">
            </a>
        </span>
        <div class="adv-dsc" style="display: inline-block;">
            <a class="d" href="<?=$arItem["DETAIL_PAGE_URL"]?>">
                <?=$arItem["NAME"]?>
            </a>
