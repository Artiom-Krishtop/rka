...
<table class="data-table bx-registration-table">
	<thead>
		<tr>
			<td colspan="2" style="display: none;"><b><?=GetMessage("AUTH_REGISTER")?></b></td>
		</tr>
	</thead>
	<tbody>
		<tr>
...
<?endif?>
		...
		<tr><td colspan="2"><p style="margin:2px 0 2px 6px; font-size: 12px;"><?echo $arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?></p></td></tr>
		<tr>
        ...
        <tr>
            <td>Телефон</td>
            <td><input type="text" name="USER_PERSONAL_PHONE" maxlength="255" value="<?=$arResult["USER_PERSONAL_PHONE"]?>" class="bx-auth-input" /></td>
        </tr>
<?// ********************* User properties ***************************************************?>
...
<script>
	$("#main_UF_SKYPE .string").attr("maxlength", 255)
</script>
