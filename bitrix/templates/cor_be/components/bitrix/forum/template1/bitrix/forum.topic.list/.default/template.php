...
?>
						<div class="forum-lastpost-box">
							<span class="forum-lastpost-date"><noindex><a rel="nofollow" href="<?=$res["URL"]["LAST_MESSAGE"]?>"><?=FormatDate('d F Y',MakeTimeStamp($res["LAST_POST_DATE"]), time())?><?//=$res["LAST_POST_DATE"]?></a></noindex></span>
