...
<h3>Уважаемый <?=$arResult["USER_NAME"]?><?/* [<?=$arResult["USER_LOGIN"]?>]*/?>!</h3>
<ul class="menu">
...
<li class="leaf"><a href="http://help.artismedia.by/" target="_blank" title="">Отправить запрос в тех. поддержку</a></li>
    <?}?>
