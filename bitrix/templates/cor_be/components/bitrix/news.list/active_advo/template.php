...
<h2 class="block-title"><?
    ...
    $APPLICATION->IncludeComponent(
        ...
        Array(
            "AREA_FILE_SHOW" => "file",
            "PATH" => "/be/include/main_active_advokat.php",
            "EDIT_TEMPLATE" => ""
        )
    );
...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<li class="views-row-odd" id="<?=$this->GetEditAreaId($arItem['ID']);?>">   
		...
		<?if($arParams["DISPLAY_NAME"]!="N" && $arItem["NAME"]):?>
            ...
            <?$db_list = CIBlockSection::GetList(array(), array('GLOBAL_ACTIVE' => 'Y',  'NAME'=>$arItem["PROPERTIES"]["KOLLEG"]["VALUE"],  "IBLOCK_ID" => 15), true, array("ID", "NAME","UF_S_OLD_ID","SECTION_PAGE_URL","SECTION_ID"));
