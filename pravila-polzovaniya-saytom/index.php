...
?><p align="center">
 <b>Правила пользования сайтом <br>
Белорусской республиканской коллегии адвокатов &nbsp;</b><span id="bx-cursor-node"> </span>
</p>
<p>
	 1. Общие условия.
</p>
...
<p>
	 1.18. Администратор сайта не отвечает за нарушение прав третьих лиц, совершенное посредством размещения на сайте адвокатами и иными лицами личных данных, иной охраняемой законом информации без соблюдения требований законодательства.
</p>
<p>
...
<p>
	 1.22. Адвокаты и пользователи при использовании размещенных на сайте материалов обязаны соблюдать исключительные права иных лиц на указанные объекты.&nbsp;
</p>
<p>
...
<p>
	 2. Учетная запись (личный кабинет) адвоката. Правила пользования.
</p>
<p>
...
<p>
	 3. Учетная запись (личный кабинет) пользователя. Правила пользования.
</p>
<p>
	 3.1. Любое лицо, которое пользуется сайтом и не является адвокатом − пользователь − вправе зарегистрировать на сайте свой личный кабинет (учетную запись).
</p>
<p>
...
<p>
	 4. Изменение и удаление учетной записи (личного кабинета).
</p>
<p>
	 4.1. Владелец учетной записи может изменить свою учетную запись самостоятельно, либо с помощью службы технической поддержки сайта. Адвокат не вправе изменять сведения о себе, перечисленные в пункте 1.8 Правил и размещаемые на сайте администратором сайта.
</p>
<p>
...
<p>
	 4.4. Все материалы, опубликованные на сайте от имени или с участием удаленной учетной записи, могут оставаться на сайте и использоваться в соответствии с настоящими Правилами, либо могут быть удалены по усмотрению собственника сайта либо по просьбе автора.
</p>
<p>
 <br>
</p>
<p>
	 5. Обязанности адвокатов и пользователей при пользовании сайтом.
</p>
<p>
	 5.1. Адвокат обязан:
</p>
...
<p>
	 6. Запрет на размещение информации на сайте.
</p>
<p>
...
<p>
	 7. Запрет на совершение действий на сайте.
</p>
<p>
