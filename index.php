...
?>
    <section class="asidenews">
        <h2 class="block-title"><span style="font-family: Georgia, serif; font-size: 13pt;"><b>Уважаемые посетители!</b></span><b>&nbsp;</b><br></h2>
        <p><span style="font-family: Georgia, serif; font-size: 13pt;">Адвокатура в Республике Беларусь - правовой институт, призванный осуществлять профессиональную правозащитную деятельность, оказывать квалифицированную юридическую помощь всем, кто в ней нуждается. </span></p>
        <p><span style="font-family: Georgia, serif; font-size: 13pt;">Сегодня каждый понимает необходимость обращения к адвокату за советом перед совершением какого-либо юридически значимого действия. Очевидно, что предотвратить наступление неблагоприятных последствий своих поступков гораздо проще, чем исправлять их с использованием правовых инструментов.</span></p>
        <p><span style="font-family: Georgia, serif; font-size: 13pt;">На данном сайте Вы можете: найти сведения обо всех адвокатах республики; изучить разъяснения адвокатов по наиболее актуальным юридическим вопросам; получить актуальную информацию о деятельности адвокатского сообщества Беларуси; в рамках онлайн-консультации получить предварительное разъяснение норм законодательства по вопросам, не требующим ознакомления с документами и иными материалами.</span></p>
        <span style="font-family: Georgia, serif; font-size: 13pt;">Для получения бесплатной юридической онлайн-консультации нажмите на кнопку "Задать вопрос".</span>
        <p></p>
