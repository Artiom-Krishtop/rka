...
<h2 class="block-title"><span style="font-family: Georgia, serif; font-size: 13pt;"><b>Уважаемые посетители!</b></span></h2>
<p>
 <i style="font-family: Georgia, serif; font-size: 11pt;"><span style="color: #0D2F62;">Если вы перешли на сайт БРКА, значит, вам требуется помощь адвоката. Обращаясь за помощью к адвокату, </span><b><span style="color: #0D2F62;">вы поступаете правильно, потому что</span></b><span style="color: #0D2F62;">:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; - крайне важно обратиться к адвокату за советом прежде, чем совершить какое-либо юридически значимое действие. Очевидно, что предотвратить наступление неблагоприятных юридических последствий своих действий гораздо проще, чем их исправлять (если такое исправление вообще возможно);&nbsp;</span></i>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span><i style="font-family: Georgia, serif; font-size: 11pt;"><span style="color: #0D2F62;">-только адвокаты в Республике Беларусь имеют право оказывать юридическую помощь гражданам, в том числе и консультирование по правовым вопросам. Все другие&nbsp;субъекты, которые предлагают юридическую помощь гражданам (интернет-ресурсы, общественные организации, юристы, не имеющие адвокатской лицензии, и т.д.), действуют нелегально;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</span></i><i style="font-family: Georgia, serif; font-size: 11pt;"><span style="color: #0D2F62;">-только адвокаты отвечают за грамотность оказанной юридической помощи и несут ответственность за качество своей работы. Иные лица, действующие нелегально, не отвечают за последствия некачественного оказания юридической помощи;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</span></i><span style="font-size: 11pt; font-family: Georgia, serif;"><i><span style="color: #0D2F62;">- только общение с адвокатом является предметом адвокатской тайны. Все иные лица не обязаны хранить в тайне информацию, полученную от вас в процессе оказания юридической помощи</span></i></span>;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span></i></span><i style="font-family: Georgia, serif; font-size: 11pt;"><span style="color: #0D2F62;">- только адвокаты постоянно совершенствуют свое профессиональное мастерство, регулярно проходят аттестацию для подтверждения своего профессионального уровня.&nbsp;</span></i><span style="color: #486DAA;"> </span><span style="color: #486DAA;"> </span>
</p>
...
<div class="region region-news">
	...
	Array(
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "Y",
		"COMPONENT_TEMPLATE" => "quest_front",
		"DETAIL_URL" => "",
		...
		"DISPLAY_TOP_PAGER" => "N",
		"FIELD_CODE" => array(0=>"DATE_ACTIVE_FROM",1=>"TIMESTAMP_X",2=>"",),
		"FILTER_NAME" => "",
...
Array(
	...
	<div class="book-ad">
		 <?$APPLICATION->IncludeFile(
                    $APPLICATION->GetTemplatePath("include_areas/book_ad.php"),
                    Array(),
                    Array("MODE"=>"html")
                );?>
	</div>
...
Array(
 ...
 <!-- /.region --> </section> </section> <br><?require($_SERVER["DOCUMENT_ROOT"]."/bitrix/footer.php");?>