...
<h2 class="smaller">Адвокаты, оказывающие правовую помощь в отрасли Интеллектуальная собственность</h2>
...
$arrSfera = array("PROPERTY_SFERA_DET"=>106947);?>
...
<div class="container">
 ...
 <div class="attachment attachment-before">
        <h2 class="smaller">Статьи адвокатов по теме Интеллектуальная собственность</h2>
<?$arrPravo = array("PROPERTY_OTR_PRAVO"=>106947);?>         
			 <?$APPLICATION->IncludeComponent(
	"bitrix:news.list", 
	"blog", 
	array(
...
<div class="attachment attachment-before" style="margin-top:20px;">
        <h2 class="smaller">Ответы адвокатов на вопросы граждан в отрасли Интеллектуальная собственность</h2>
<?$arrPravor = array("PROPERTY_OTR_PRAVO"=>106947);?>         
			 <?$APPLICATION->IncludeComponent(
	"bitrix:news.list", 
	"voprosy", 
	array(
